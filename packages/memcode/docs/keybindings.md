...
All keyboard shortcuts can be customized via `~/.memorix/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.memorix/agent/keybindings.json`:
