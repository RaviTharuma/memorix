...
Discovery rules:
- In `~/.memorix/agent/skills/` and `.memorix/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.memorix/settings.json`:
