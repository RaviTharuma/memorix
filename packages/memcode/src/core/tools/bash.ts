...
import { Container, Text, truncateToWidth } from "@memorix/tui";
...
/**
 * Create bash operations using memcode's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want memcode's
